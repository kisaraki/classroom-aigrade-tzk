...
下列項目依各列狀態追蹤。D-01、D-03、D-10 及 D-11 日期部分已於 2026-09-23 由使用者核准；D-04、D-07、D-11 的 Recent Authentication／Recovery 時窗與 Phase 6 上傳門檻於 2026-09-24 核准，其餘建議仍不是已核准規則；實作到所列關卡前，必須先確認並回寫本節與相關正文。平台能力不足時保留實際證據，不可用模擬結果宣稱 Production 可用。
